# Task Manager Client - Documentation

This folder contains learning documentation for the React frontend, organized by topic.
...
| # | Topic | Status | Description |
|---|-------|--------|-------------|
| 13 | [Styling with Tailwind](./13-styling-tailwind.md) | Pending | Utility classes, responsive design |
| 14 | [Component Patterns](./14-component-patterns.md) | Pending | Composition, compound components |
